...
public class CamelPoker {
    ...
    static class CardsHand {
        ...
        public CardsHand(String line) {
            ...
            this.handType = HandType.evaluate(this);
        }
    ...
    enum HandType {
        ...
        static HandType evaluate(CardsHand cardsHand) {
            List<CardGroup> groupsInHand = new ArrayList<>(cardsHand.cards.stream().collect(groupingBy(Function.identity(), Collectors.counting())).entrySet()
